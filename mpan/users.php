                    ...
                    <td align='right' colspan="2">
                        <table width='100%' id="table1">
                            <tr>
                                ...
                                <td><INPUT type="checkbox" name="CUST_DISABLED" <?php print ($flag & CUST_DISABLED)?"checked":"" ?>></td>
                            ...
                            <tr>
                                ...
                                <td><INPUT type="checkbox" name="CUST_SUPERUSER" <?php print ($flag & CUST_SUPERUSER)?"checked":"" ?>></td>
                                <td align='right' width="136">Content Manager</td>
                                <td width="20"><INPUT type="checkbox" name="CUST_CONTENT" <?php print ($flag & CUST_CONTENT)?"checked":"" ?>></td>
                                <td width="156">&nbsp;</td>
                                <td width="67">&nbsp;</td>
                            </tr>
                        </table>
